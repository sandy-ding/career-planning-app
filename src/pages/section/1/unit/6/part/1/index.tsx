...
const overview = {
  title: "二维空间旋转",
  description:
    "<strong>指导语</strong>：你将在屏幕正中央看到一个字母，它会旋转不同的角度，请判断该字母是正向（R）还是反向（<span class='mirror'>R</span>）。如果是正向，请按“F”键，如果是反向，请按“J”键。在判断正确的前提下，反应越快越好。测试分练习和正式2部分，练习结束后点击“开始”按钮，进行正式测验。下面点击“练习”，开始练习吧。",
  audioUrl: "https://career-planning-app.oss-cn-beijing.aliyuncs.com/1-6-1.mp3",
};
...
const angles = [
  300, 240, 60, 180, 0, 240, 60, 240, 180, 0, 240, 300, 120, 60, 180, 300, 180,
  0, 120, 180, 300, 0, 120, 60, 120, 240, 60, 300, 120, 240, 0, 120, 180, 300,
  0, 60,
];
const directions = [

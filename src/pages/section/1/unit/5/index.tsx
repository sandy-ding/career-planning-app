...
const overview1 = {
  title: "表格分析",
  description:
    "<strong>指导语</strong>：这是信息检索与归纳能力测验的第一段测验。<br/><br/>您将在电脑界面上回答一系列问题，屏幕只会呈现一道题，确认选项后将会自动进入下一题。请尽力在8分钟内完成，8分钟后将直接入下一段测验。<br/><br/>现在，请开始测验，按照界面上的指示进行作答。",
  audioUrl: "https://career-planning-app.oss-cn-beijing.aliyuncs.com/1-5-1.mp3",
};
const overview2 = {
  title: "图形分析",
  description:
    "<strong>指导语</strong>：这是信息检索与归纳能力的第二段测验。<br/><br/>您将在电脑界面上回答一系列问题，屏幕只会呈现一道题，确认选项后将会自动进入下一题。请尽力在8分钟内完成，8分钟后将直接入下一段测验。<br/><br/>现在，请开始测验，按照界面上的指示进行作答。",
